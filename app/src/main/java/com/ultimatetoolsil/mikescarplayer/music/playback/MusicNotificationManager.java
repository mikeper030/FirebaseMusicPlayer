...
import com.ultimatetoolsil.mikescarplayer.MainActivity;
...
public class MusicNotificationManager {
    ...
    public Notification createNotification() {
        ...
        mNotificationBuilder
                ...
                .setLargeIcon(Utils.getLargeIcon(context))
    ...
    private void updateMetaData(Song song) {
        mediaSession.setMetadata(new MediaMetadataCompat.Builder()
                .putBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART, Utils.getLargeIcon(context))
